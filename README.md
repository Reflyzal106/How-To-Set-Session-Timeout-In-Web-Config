# [SOLVED] How-To-Set-Session-Timeout-In-Web-Config
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/how-to-set-session-timeout-in-web-config)
>
...
Yes, your configuration is correct. The 'timeout' attribute sets the session timeout value for InProc mode.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/how-to-set-session-timeout-in-web-config)**
